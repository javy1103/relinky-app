...
var gulp = require('gulp'),
    ...
    // commmon
    gulp.task('js_common_landing', function () {
        return gulp.src([
            ...
            // one page nav
            "assets/landing/js/custom/jquery.nav.js"
        ])
            ...
            .pipe(gulp.dest('public/js/landing'))
            .pipe(plugins.uglify({
                mangle: true
            }))
    ...
    // custom uikit
    gulp.task('js_uikit_landing', function () {
        return gulp.src([
            // uikit core
            ...
            "assets/landing/js/custom/uikit_beforeready.js"
        ])
