                    ...
                    <li>
                        <div class="timeline timeline_small uk-margin-bottom">
                            ...
                            <div class="timeline_item">
                                ...
                                <div class="timeline_content">Deleted post <a href="#"><strong>Rem non odit eaque consectetur occaecati et.</strong></a></div>
                            </div>
                            <div class="timeline_item">
                            ...
                            <div class="timeline_item">
                                ...
                                <div class="timeline_content">
                                    New comment on post <a href="#"><strong>Id quaerat consequatur dolores qui adipisci.</strong></a>
                                    <div class="timeline_content_addon">
                                        <blockquote>
                                            Quo est facilis quia sit qui suscipit quidem voluptas doloremque nihil placeat modi temporibus qui.&hellip;
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <ul class="md-list md-list-addon">
                                            <li>
                                                ...
                                                <div class="md-list-content">
                                                    ...
                                                    <span class="uk-text-small uk-text-muted">Nesciunt enim dolores facilis.</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <ul class="md-list md-list-addon chat_users">
                            <li>
                                ...
                                <div class="md-list-content">
                                    ...
                                    <span class="uk-text-small uk-text-muted uk-text-truncate">Quibusdam soluta laboriosam.</span>
                                </div>
                            </li>
                            <li>
                                <div class="md-list-addon-element">
                            ...
                            <li>
                                <div class="md-list-addon-element">
                                    ...
                                    <img class="md-user-image md-list-addon-avatar" src="img/avatars/avatar_04_tn.png" alt=""/>
                                </div>
                                <div class="md-list-content">
                                    <div class="md-list-action-placeholder"></div>
                        ...
                        <div class="chat_box_wrapper chat_box_small" id="chat">
                            <div class="chat_box chat_box_colors_a">
                                ...
                                <div class="chat_message_wrapper chat_message_right">
                                    <div class="chat_user_avatar">
                                        <img class="md-user-image" src="img/avatars/avatar_03_tn.png" alt=""/>
                                    </div>
                                    <ul class="chat_message">
                                        <li>
                                            <p>
